cask "dyalog-kbd-it" do
    version "1.0.0"
    sha256 "fdb8e77307c7c16ce6459d74826950bac724167c7b4e8215ea412acfd614a83a"
  
    url "https://packages.dyalog.com/homebrew/DyalogAltIT.zip"
    ...
    caveats <<~EOS
      The Dyalog Alt IT keyboard layout has been installed.
  
      To use the layout, go to System Preferences > Keyboard > Input Sources,
      and add "Dyalog Alt IT" under the "Others" section.
    EOS
  end